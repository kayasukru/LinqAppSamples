...
public partial class NorthwindContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            optionsBuilder
            .UseLoggerFactory(myLoggerFactory) // ILogger
                .UseSqlServer("Data Source=SKYN\\SQLEXPRESS; Initial Catalog=Northwind; Integrated Security=True; Encrypt=False; ");
        }
